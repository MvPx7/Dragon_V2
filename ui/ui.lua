...
local function makeTabBtn(label,order)
	local b=Instance.new("TextButton"); b.Size=UDim2.new(0.2,-2,1,0)
...
-- Tab switching
local allTabs={{btn=tabMain,content=contentMain},{btn=tabRaid,content=contentRaid},{btn=tabTeleport,content=contentTeleport},{btn=tabConfig,content=contentConfig},{btn=tabInspect,content=contentInspect}}

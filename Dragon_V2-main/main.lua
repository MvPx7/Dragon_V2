local RepoURL = getgenv().Dragonsz_Repo or "https://raw.githubusercontent.com/MvPx7/Dragon_V2/main/"
...
local Modules = {
    ...
    Inspector = LoadModule("modules/inspector.lua"),  -- NOVO
    Quest     = LoadModule("modules/quest.lua"),
}
